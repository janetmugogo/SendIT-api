...
class CreateParcel(Resource):
    ...
    parser.add_argument(
        'user_id', type=int, required=True, help='user_id  is required', location='json')
    parser.add_argument(
        'sender_name', type=str, required=True, help='sender name  is required', location='json')

    parser.add_argument(
        'phone_number', type=int, required=True, help='phone number  is required', location='json')

    parser.add_argument(
        'id_number', type=int, required=True, help='id number is required', location='json')
    parser.add_argument(
    ...
    parser.add_argument(
         'weight', type=int, required=True, help='weight is required', location='json')
    ...
    def post(self):
        ...
        username_object = get_jwt_identity()
